...
//    private int k=20;
//    LODRankingFunction rankingFunction;
//
...
//                                              double errorRateThreshold,int k,LODRankingFunction rankingFunction) {
//        this(new ValidatorType[]{validator},new double[]{errorRateThreshold},k,rankingFunction);
//    }
//
...
//
//    public DFSDiscovererMultiStdRankingFxTopK(ValidatorType[] validators, double[] errorRateThresholds
//                                            , int k, LODRankingFunction rankingFunction) {
//        if(validators.length!=errorRateThresholds.length){
//            throw new InvalidParameterException("参数数量不匹配");
//        }
//        this.validatorTypes = validators;
...
//            search(node);
//        }
//        PriorityQueue ods = tree.getValidODs();
